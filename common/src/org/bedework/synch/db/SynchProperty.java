...
/** An arbitrary property value in bedework synch.
 *
 *  @version 1.0
 */
public class SynchProperty extends DbItem<SynchProperty> {
  private String name;
   ...
   */
  public SynchProperty(final String name,
                    final String value) {
    super();
    this.name = name;
    this.value = value;
   ...
   */
  public boolean update(final SynchProperty from) {
  ...
  @Override
  public int compareTo(final SynchProperty that) {
    if (that == this) {
      return 0;
    }
  ...
  @Override
  public Object clone() {
    return new SynchProperty(getName(), getValue());
  }
}
